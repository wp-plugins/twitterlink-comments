        ...
        class twitlink {
            ...
            function handle_options() {
                ...
                if (isset ( $_POST ['save'] )) {
                    ...
                    $use_profile = intval($_POST['use_profile']);
                    $profile_field = $_POST['profile_field'];
                    ...
                    $options['profile_field'] = wp_filter_nohtml_kses($profile_field);
            ...
            function add_twitlink_to_comment_array($array){
                ...
                foreach($array as $comment){
                    if($options['use_profile'] == '1'){
                        $twitid = get_user_meta($comment->user_id,$options['profile_field'],true);
                    } else {
